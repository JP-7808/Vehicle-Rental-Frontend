                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {new Date(booking.pickup.datetime).toLocaleString()} • {booking.pickup.locationName}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {new Date(booking.dropoff.datetime).toLocaleString()} • {booking.dropoff.locationName}
                          </p>
                        </div>
                      </div>
                    </div>
