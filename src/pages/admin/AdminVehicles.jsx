    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden h-full flex flex-col">
      ...
      <div className="h-48 bg-gray-200 relative">
        ...
        <div className="absolute top-3 right-3 flex flex-col space-y-2">
          ...
          <span className={`px-3 py-1.5 rounded-full text-xs font-medium whitespace-nowrap bg-blue-100 text-blue-800`}>
      ...
      <div className="p-4 flex-grow">
        <h3 className="font-semibold text-gray-900 mb-2 truncate">{vehicle.title}</h3>
        
        <div className="space-y-2 text-sm text-gray-600 mb-4">
          <div className="flex items-center space-x-2">
            <MapPin className="h-4 w-4 flex-shrink-0" />
            <span className="truncate">{vehicle.locations?.[0]?.city || 'No location'}</span>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="truncate">{vehicle.fuelType} • {vehicle.make} {vehicle.model}</span>
          </div>
          <div className="flex items-center space-x-2">
...
export default function AdminVehicles() {
  ...
  useEffect(() => {
    fetchVehicles();
  }, [currentPage, filters.search, filters.vehicleType, filters.city, filters.status]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">Manage all vehicles in the system</p>
            </div>
            <button
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Pagination - shows when there are 9+ vehicles (8 per page) */}
            {totalPages > 1 && (
